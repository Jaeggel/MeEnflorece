<section id="team">
	...
	<div class="portfolio">
        <div class="container">
            <div class="heading">
        	<h2>Ramos de Amistad <strong>Me Enflorece</strong></h2>
        	<p>Enflorecete con los Ramos de Amistad</p>
        </div><!-- //end heading -->
        <ol class="breadcrumb">
						...
						<div class="product-image-wrapper">
							<div class="single-products">
								<div class="productinfo text-center">
									...
									<a href="<?php echo site_url('flores//seleccion_ramo_SS/'.$flores_item['id_articulo']);?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>  Comprar</a>
								</div>
							</div>
							<br>
						</div>
