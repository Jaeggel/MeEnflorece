...
<?php echo form_open('Flores/perfil_usuario_Per'); ?>
    <section id="team">
      <!-- Team BEGIN -->
      <div class="portfolio">
        <div class="container">
          <div class="heading">
            ...
            <h3>2.- Ingresa tus datos personales</h3>
            <p>Trabajamos para Brindarte Seguridad</p>
          </div><!-- //end heading -->

          <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/') ?>">Home</a></li>
            <li><a href="<?php echo site_url('Flores/pers_ramo') ?>">Galeria de Flores</a></li>
            <li class="active">Ramo creado</li>
          </ol>
          ...
          <div class="row">
            ...
            <form>
             ...
             <div class="">
              ...
              <div class="">
               <h4 for="tarjetaPR" class="" <span style="color:#0B0B61;"><font color="red">*</font> Número de Tarjeta</h4>
             </div>

             <div class="">
              <input type="text" style="width:500px;height:15px;" name="tarjetaPR" id="tarjetaPR" placeholder="Tu Tarjeta" class="form-control" required maxlength="16" onkeypress="return solonumero(event)" onblur="validarTamaño1()>
            </div>
            <div class="">
             <h4 for="codigoTPR" class="" <span style="color:#0B0B61;"><font color="red">*</font> Código de Seguridad (CVV)</h4>

             <input type="password" name="codigoTPR" style="width:500px;height:15px;" placeholder="CVV" class="form-control" min="0" max="4" required maxlength="3" onkeypress="return solonumero(event)">
           </div>
           <div class="">
             <h4 for="mesPR" class="" <span style="color:#0B0B61;"><font color="red">*</font> Mes</h4>

             <SELECT name="mesPR" SIZE=1 style="width:500px;height:15px;" class="form-control" requerid>
          ...
          <div class="">
          <h4 for="anoPR" class="" <span style="color:#0B0B61;"><font color="red">*</font> Año</h4>

           <SELECT name="anoPR" SIZE=1 style="width:500px;height:15px;" class="form-control" requerid>
        ...
        <br>
        <button type="submit" class="btn-danger btn-md btn-block" style="width:500px;height:60px;" onclick="sendHelpCont(); sendExitCont(); sendErrorCont();">Confirmar</button>
      </div>
    </div>
...
<div class="col-md-4" style="background-color: #f2f2f2;">
 ...
 <div>
  <p>Fecha Entrega: <?php echo $envio['fechaP'].'<br>'; ?></p>
  <p>Horario de Entrega: <?php echo $envio['horarioP'].'<br>'; ?></p>
</div>

<div>
  <h5>Datos de entrega: </h5>
  <hr align="center" width="60%">
  <p ><?php echo $envio['nombreP']; ?> <?php echo $envio['apellidoP']; ?> </p>
  <p><?php echo $envio['direccionP']; ?>, <?php echo $envio['ciudadP'].'<br>'; ?></p>
  <p><?php echo $envio['codigoP'].'<br>'; ?></p>
</div>
...
<div>
  ...
  <div class="row">
    <div class="col-md-8 left">
      <p><?php echo $envio['nombrePer'].'<br>'; ?></p>
    </div>
    <div class="col-md-4 right">
      <strong><p>$ <?php echo $this->session->userdata('totalP').'<br>'; ?></p></strong>
    </div>
...
<div>
  <div class="row">
    ...
    <div class="col-md-4 right">
      <strong><p id="total">$ <?php echo $this->session->userdata('totalP')+2.50.'<br>'; ?> </p></strong>
    </div>
