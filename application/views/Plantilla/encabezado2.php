        ...
        <nav class="navbar navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url("index.php/Flores/logout");?>" accesskey="h">
                ...
                <div class="collapse navbar-collapse navbar-responsive-collapse">
                    <ul class="nav navbar-nav">
                         ...
                         <li class="page-scroll">
                            <a href="<?php echo site_url("Flores/perfil_usuario");?>"  accesskey="u">Perfil Usuario</a>
                        </li>
                            ...
                            <li>
                                <a href="<?php echo site_url("Flores/ramos_aniv_l");?>" style="color: #3f5263">
                                  <span class="item">
                            ...
                            <li>
                                <a href="<?php echo site_url("Flores/ramos_amor_l");?>" style="color: #3f5263">
                                  <span class="item">
                                    <span class="item-left">
                            ...
                            <li>
                                <a href="<?php echo site_url("Flores/ramos_regalos_l");?>" style="color: #3f5263">
                                  <span class="item">
                                    <span class="item-left">
                              ...
                              <li>
                                <a href="<?php echo site_url("Flores/ramos_amis_l");?>" style="color: #3f5263">
                                  <span class="item">
                                    <span class="item-left">
                              ...
                              <li>
                                <a href="<?php echo site_url("Flores/ramos_perdon_l");?>" style="color: #3f5263">
                                  <span class="item">
                                    <span class="item-left">
                        ...
                        <li class="page-scroll">
                            <a href="<?php echo site_url("Flores/ramos_l");?>" accesskey="r">Ramos</a>
                        </li>
                        <li class="page-scroll">
                            <a href="<?php echo site_url("Flores/pers_ramo");?>" accesskey="p">Arma tu Ramo</a>
                        </li>

                        <li class="dropdown">
                            <a class="dropdown-toggle" onclick="clickCounter()" data-toggle="dropdown" href="#">Ayuda
                            <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                            <li>
                                <a href="#" data-toggle="modal" onclick="clickCounter()" data-target="#como_comprar" style="color: #3f5263">
                                  <span class="item">
                                    <span class="item-left">
                        ...
                        <li class="page-scroll">
                            <a href="<?php echo site_url("Flores/logout");?>">Cerrar Sesión</a>
                        </li>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-8 product_content">
                                ...
                                <h4>
                                    Estos consejos junto al cuidado de Interflora en la calidad y frescura de tus rosas crean un regalo especial cada día.
                                </h4>
                                <hr>
                            </div>
                            <div class="row">
...
<script type="text/javascript">
    ...
    $(window).on("beforeunload", function() {
        ...
        if (localStorage.clickcount) {
            ...
            console.log("EXIT: You have clicked the button " + localStorage.clickcount + " time(s).");
        } else {
            console.log("Sorry, your browser does not support web storage...");
        }
        return inFormOrLink ? "Do you really want to close?" : null; 
    });
    function sendExitCont()
    {
        var d = new Date();
        ...
        var output = d.getFullYear() + '/' +
            ...
            ((''+day).length<2 ? '0' : '') + day;
        var cont=localStorage.clickcount;
        localStorage.clear();
        $.ajax({
            url: "http://localhost/MeEnflorece/index.php/Flores/setExitCont",
            data: {"contE":cont,"fechaE":output},
            dataType: "json",
            type: "POST",
